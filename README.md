...
#### 主干的定位
1. 主语：拒收的**独立名词**性结构(名词 代词 分词(分身love, loved) 从句 it)
In his eyes, **Jack** is aliar. 名词
**Living** in a city is always convenient. 分词
**That no one can live without water** is true. 从句作为主语（that 开头）
**It** is true that no one can live without water. it 是形式主语
